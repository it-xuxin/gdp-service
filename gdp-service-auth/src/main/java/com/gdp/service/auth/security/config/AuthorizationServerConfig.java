...
import com.gdp.service.auth.security.core.userdetails.app.AppUserDetails;
import com.gdp.service.auth.security.core.userdetails.app.AppUserDetailsServiceImpl;
import com.gdp.service.auth.security.extension.mobile.SmsCodeTokenGranter;
import com.gdp.service.auth.security.extension.refresh.PreAuthenticatedUserDetailsService;
...
//        clientUserDetailsServiceMap.put(SecurityConstants.WEAPP_CLIENT_ID, memberUserDetailsService); // 微信小程序客户端
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(new ClassPathResource("gdp-service-auth.jks"), "123456".toCharArray());
        KeyPair keyPair = factory.getKeyPair("gdp-service-auth", "123456".toCharArray());
        return keyPair;
    }
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            if (principal instanceof SysUserDetails) {
                ...
                if (StrUtil.isNotBlank(appUserDetails.getAuthenticationIdentity())) {
                    additionalInfo.put("authenticationIdentity", appUserDetails.getAuthenticationIdentity());
                }
            }
